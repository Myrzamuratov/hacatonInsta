...
const desc = document.querySelector("#navbar_desc2");
...
const navbarItemsList = document.querySelector(".navbar-burger-list");
const burgerCloser = document.querySelector(".burger-close");
burgerMenu.addEventListener("click", () => {
  navbarItemsList.style.display = "block";
});

burgerCloser.addEventListener("click", () => {
  navbarItemsList.style.display = "none";
});
